...
| Axios | 1.20.0 | Cliente HTTP compartido, incorporación de credenciales Bearer en solicitudes protegidas y conservación de sus errores nativos para inspección genérica; utilizado por el servicio de autenticación. |
