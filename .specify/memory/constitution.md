...
- List of modified principles:
  - Added: 1. Separación de responsabilidades y modularidad
  - Added: 2. Lógica de negocio
  - Added: 3. Integración y confiabilidad de fuentes externas
  - Added: 4. Testing obligatorio
  - Added: 5. Calidad y estabilidad de las pruebas
  - Added: 6. Calidad de código
  - Added: 7. Control de calidad automatizado
  - Added: 8. Seguridad
  - Added: 9. Contratos entre componentes
  - Added: 10. Documentación de la API
  - Added: 11. Simplicidad antes que sobreingeniería
  - Added: 12. Cambios controlados
- Added sections: Reglas Generales de Aplicación, Evolución y Conflictos
