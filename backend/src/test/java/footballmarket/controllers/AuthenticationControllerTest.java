...
class AuthenticationControllerTest {
  ...
  void deberiaRegistrarUsuario() throws Exception {
    RegisterRequestDTO request =
            new RegisterRequestDTO("register@test.com", "password");
  ...
  void deberiaRechazarRegistroCuandoElEmailEsInvalido() throws Exception {
    RegisterRequestDTO request =
            new RegisterRequestDTO("email-invalido", "password");
  ...
  void deberiaRechazarRegistroCuandoElEmailEstaVacio() throws Exception {
    RegisterRequestDTO request =
            new RegisterRequestDTO("", "password");
            ...
            .andDo(
                    document(
                            ...
                            responseFields(
                                    fieldWithPath("token")
                                            .description(
                                                    "Token JWT utilizado para autenticar las solicitudes"))));
  }
  ...
  void deberiaRechazarLoginCuandoElEmailNoExiste() throws Exception {
    LoginRequestDTO request =
            new LoginRequestDTO(
                    "nonexistent-controller@test.com",
                    "password");
  ...
  void deberiaRechazarLoginCuandoLaContrasenaEsIncorrecta() throws Exception {
    RegisterRequestDTO registerRequest =
            new RegisterRequestDTO(
                    "wrong-password-controller@test.com",
                    "password");
